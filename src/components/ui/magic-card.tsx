...
export function MagicCard(props: MagicCardProps) {
  ...
  return (
    <motion.div
      ...
      style={{
        background: useMotionTemplate`
          linear-gradient(var(--color-background, var(--fv-charcoal, #121215)) 0 0) padding-box,
    ...
    >
      <div className="bg-background bg-[var(--color-background,var(--fv-charcoal,#121215))] absolute inset-px z-20 rounded-[inherit]" />
